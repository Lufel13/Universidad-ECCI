...
def main():
    ...
    #Crea el administrador del indice de rutas
    manager = pywrapcp.RoutingIndexManager(len(data['matriz_distancias']), data['num_vehiculos'], data['deposito'])

    #Crea del modelo de enrutamiento
    routing = pywrapcp.RoutingModel(manager)

    #Crea  y registra una devolucion de llamada de distancia
    ...
    routing.AddDimension(
        ...
        0, # Sin holgura
        3000, # Distancia maxima de viaje del vehiculo
        True, # Iniciar el acumulador en cero
        dimension_name)
    distance_dimension = routing.GetDimensionOrDie(dimension_name)
    distance_dimension.SetGlobalSpanCostCoefficient(100)

    # Configurar los parametros de busqueda.
    ...
    #imprimir la solucion en la consola
    if solution:
